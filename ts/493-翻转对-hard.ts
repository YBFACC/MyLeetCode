...
function reversePairs(nums: number[]): number {
  ...
  for (let i = Len - 1; i >= 0; i--) {
    ...
    const temp = avl.search_count(target)
    res += temp
    avl.insert(nums[i])
